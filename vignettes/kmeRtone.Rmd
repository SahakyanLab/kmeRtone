---
title: "kmeRtone: Multi-Purpose and Transferrable K-Meric Enrichment/Depletion Analysis Software"
output:
...
```{r, tidy = TRUE, eval = TRUE, echo = FALSE, fig.align='center', out.width='100%'}
